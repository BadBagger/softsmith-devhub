...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.23-signed-app-refresh", "DevHub.apk"),
        ...
        new AppInfo("TidyPilot", "tidypilot", "BadBagger", "tidypilot", "com.smithware.tidypilot", "Home reset around real life", "Home", "Build a gentle cleaning plan around work shifts, energy check-ins, skipped tasks, room status, and local room photo scans.", R.drawable.managermeet_logo, R.drawable.preview_managermeet, Color.rgb(135, 168, 120), "v0.1.1-polish", "TidyPilot.apk"),
