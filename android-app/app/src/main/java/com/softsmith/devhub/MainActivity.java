...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.54-unfogged", "DevHub.apk"),
        ...
        new AppInfo("Unfogged", "unfogged", "BadBagger", "unfogged", "com.smithware.unfogged", "Reveal the world as you explore it.", "Travel", "Turn everyday travel into a local-first fog-of-war exploration map with foreground-only exploring, private trips, stats, achievements, and no location upload.", R.drawable.unfogged_logo, R.drawable.preview_unfogged, Color.rgb(124, 255, 188), "v0.1.0-mvp", "Unfogged.apk"),
