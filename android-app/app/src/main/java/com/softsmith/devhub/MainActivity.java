...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("Codex Buddy", "codex-buddy", "BadBagger", "codex-buddy", "com.softsmith.codexbuddy", "Floating AI chat", "Tools", "Keep a draggable OpenAI chat bubble available over other Android apps.", R.drawable.codexbuddy_logo, R.drawable.preview_codexbuddy, Color.rgb(70, 214, 181), "v0.1.0-overlay-chat", "CodexBuddy.apk"),
