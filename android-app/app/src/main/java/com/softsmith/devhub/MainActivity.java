...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("Smithware Command Hub", "smithware-command-hub", "BadBagger", "smithware-command-hub", "com.smithware.central", "Life apps, one command center", "Tools", "Monitor local Smithware cards, alerts, daily briefs, assistant summaries, and privacy-first settings from one dashboard.", R.drawable.smithware_command_hub_logo, R.drawable.preview_buildsmith, Color.rgb(255, 138, 28), "v0.1.2-startup-safe", "SmithwareCommandHub.apk"),
