...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.45-pivotfit-checkin-refine", "DevHub.apk"),
        ...
        new AppInfo("PivotFit", "pivotfit", "BadBagger", "pivotfit", "com.pivotfit.app", "Train around real life", "Fitness", "Builds workouts around today's time, energy, equipment, soreness, location, and schedule.", R.drawable.pivotfit_logo, R.drawable.preview_pivotfit, Color.rgb(182, 255, 59), "v0.1.10-checkin-refine", "PivotFit.apk"),
