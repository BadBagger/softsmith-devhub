...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.34-pivotfit-generated-guidance", "DevHub.apk"),
        ...
        new AppInfo("PivotFit", "pivotfit", "BadBagger", "pivotfit", "com.pivotfit.app", "Train around real life", "Fitness", "Builds workouts around today's time, energy, equipment, soreness, location, and schedule.", R.drawable.pivotfit_logo, R.drawable.preview_pivotfit, Color.rgb(182, 255, 59), "v0.1.6-generated-guidance", "PivotFit.apk"),
        ...
        new AppInfo("TidyPilot", "tidypilot", "BadBagger", "tidypilot", "com.smithware.tidypilot", "Home reset around real life", "Home", "Build a gentle cleaning plan around work shifts, energy check-ins, skipped tasks, room status, and local room photo scans.", R.drawable.tidypilot_logo, R.drawable.preview_tidypilot, Color.rgb(64, 196, 176), "v0.1.3-scan-detail", "TidyPilot.apk"),
