...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("HomeMind", "homemind-android", "BadBagger", "homemind-releases", "com.smithware.homemind", "Your private AI, anywhere.", "Tools", "Connect securely to your private HomeMind desktop over Tailscale, continue conversations, attach screenshots, review broker/Codex handoff status, see queued Codex batch progress, run, pause, resume, or cancel Codex batch work, and see whether a batch is an app-build, app-improvement, or prompt-intake workflow. Pair with desktop v0.26.58 for sanitized Prompt Intake Preview labels.", R.drawable.homemind_logo, R.drawable.preview_homemind, Color.rgb(85, 210, 190), "android-v0.5.17-workflow-labels", "HomeMind.apk"),
