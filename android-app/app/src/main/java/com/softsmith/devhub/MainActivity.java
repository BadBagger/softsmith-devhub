...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("BuildSmith", "buildsmith", "BadBagger", "buildsmith", "com.smithware.buildsmith", "Build-ready app plans", "Tools", "Turn rough app ideas into organized blueprints, Codex prompts, screen plans, data models, launch checklists, and transparent icon exports.", R.drawable.buildsmith_logo, R.drawable.preview_buildsmith, Color.rgb(231, 121, 43), "v0.1.0-devhub", "BuildSmith.apk"),
