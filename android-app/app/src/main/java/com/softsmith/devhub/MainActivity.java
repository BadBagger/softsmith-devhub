...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("HomeMind", "homemind-android", "BadBagger", "homemind-releases", "com.smithware.homemind", "Your private AI, anywhere.", "Tools", "Connect securely to your private HomeMind desktop over Tailscale, continue conversations, review read-only Website Agency status, and see the paired desktop version from your phone.", R.drawable.homemind_logo, R.drawable.preview_homemind, Color.rgb(85, 210, 190), "v0.5.10-desktop-version-status", "HomeMind.apk"),
