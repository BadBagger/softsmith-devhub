...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("HomeMind", "homemind-android", "BadBagger", "homemind-releases", "com.smithware.homemind", "Your private AI, anywhere.", "Tools", "Connect securely to your private HomeMind desktop over Tailscale, continue conversations, attach screenshots, review broker/Codex handoff status, see queued Codex batch progress, run, pause, resume, or cancel Codex batch work, see safe Prompt Intake Preview labels, and approve Website Agency sender setup packets after device unlock.", R.drawable.homemind_logo, R.drawable.preview_homemind, Color.rgb(85, 210, 190), "android-v0.5.19-sender-approvals", "HomeMind.apk"),
