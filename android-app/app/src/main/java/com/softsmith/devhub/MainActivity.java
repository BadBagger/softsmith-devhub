...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.86-lifehub-signed", "DevHub.apk"),
        ...
        new AppInfo("LifeHub Queue", "lifehub-queue-monitor", "BadBagger", "lifehub-queue-monitor", "com.smithware.lifehubqueue", "Queue status on your phone", "Tools", "Monitor LifeHub Command Center queues, submit queued plans, cancel waiting work, and pin the current queue state as a home-screen widget.", R.drawable.lifehub_queue_logo, R.drawable.preview_lifehub_queue, Color.rgb(88, 166, 255), "v0.1.1-release-signed", "LifeHubQueue.apk"),
