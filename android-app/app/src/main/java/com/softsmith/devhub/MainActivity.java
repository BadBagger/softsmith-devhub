...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("HomeMind", "homemind-android", "BadBagger", "homemind-android", "com.smithware.homemind", "Your private AI, anywhere.", "Tools", "Connect securely to your private HomeMind desktop over Tailscale, pair with a local token, and continue conversations without a paid cloud AI API.", R.drawable.homemind_logo, R.drawable.preview_homemind, Color.rgb(85, 210, 190), "v0.1.0", "HomeMind.apk"),
