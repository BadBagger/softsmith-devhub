...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.87-lifehub-installer-safe", "DevHub.apk"),
        ...
        new AppInfo("HomeMind", "homemind-android", "BadBagger", "homemind-releases", "com.smithware.homemind", "Your private AI, anywhere.", "Tools", "Connect securely to your private HomeMind desktop over Tailscale, continue conversations, attach screenshots, review broker/Codex handoff status, see queued Codex batch progress, run, pause, resume, or cancel Codex batch work, see safe Prompt Intake Preview labels, approve Website Agency sender setup packets after device unlock, and add the Google Places lead-search key from the phone without storing it on Android.", R.drawable.homemind_logo, R.drawable.preview_homemind, Color.rgb(85, 210, 190), "android-v0.5.20-google-places-key", "HomeMind.apk"),
        new AppInfo("JellyMix", "jellymix", "BadBagger", "jellymix", "com.smithware.jellymix", "Jellyfin music discovery", "Entertainment", "Stream Jellyfin music with private listening signals, tailored mixes, custom themes, queue controls, favorites sync, and an in-app visualizer.", R.drawable.jellymix_logo, R.drawable.preview_jellymix, Color.rgb(0, 217, 181), "v0.1.0-visualizer-test", "JellyMix.apk"),
