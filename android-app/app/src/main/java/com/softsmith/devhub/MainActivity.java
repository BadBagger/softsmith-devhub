...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        new AppInfo("Smithware Studios", "softsmith-devhub", "BadBagger", "softsmith-devhub", "com.softsmith.devhub", "Private app updates", "Tools", "Update this hub and every Smithware app from one place.", R.drawable.devhub_logo, R.drawable.preview_devhub, Color.rgb(0, 180, 220), "v2.1.58-gutcheck", "DevHub.apk"),
        ...
        new AppInfo("GutCheck", "gutcheck", "BadBagger", "gutcheck", "com.gutcheck.app", "Why do I feel bad today?", "Health", "Privately connect meals, symptoms, bathroom patterns, sleep, water, mood, medicines, and supplements with transparent possible-pattern evidence and doctor-summary PDF sharing.", R.drawable.gutcheck_logo, R.drawable.preview_gutcheck, Color.rgb(100, 116, 92), "v0.5.0-private-journal", "GutCheck.apk"),
