...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("Codex Buddy", "codex-buddy", "BadBagger", "codex-buddy", "com.softsmith.codexbuddy", "Codex status bridge", "Tools", "Show phone notifications when existing Codex work is done or needs attention.", R.drawable.codexbuddy_logo, R.drawable.preview_codexbuddy, Color.rgb(70, 214, 181), "v0.2.0-status-bridge", "CodexBuddy.apk"),
