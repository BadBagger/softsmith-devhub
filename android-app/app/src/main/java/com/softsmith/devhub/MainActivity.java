...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("Order Radar", "order-radar", "BadBagger", "order-radar", "com.smithware.orderradar", "Forecast orders before you run out", "Work", "Count what is on hand, forecast movement to the next truck, build order drafts, and review delivery surprises.", R.drawable.order_radar_logo, R.drawable.preview_order_radar, Color.rgb(69, 160, 126), "v0.4.0-order-photo-import", "OrderRadar.apk"),
