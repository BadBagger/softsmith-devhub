...
public class MainActivity extends Activity {
    ...
    private final AppInfo[] apps = new AppInfo[] {
        ...
        new AppInfo("JellyMix", "jellymix", "BadBagger", "jellymix", "com.smithware.jellymix", "Jellyfin music discovery", "Entertainment", "Stream Jellyfin music with private listening signals, tailored mixes, custom themes, queue controls, favorites sync, and an in-app visualizer.", R.drawable.jellymix_logo, R.drawable.preview_jellymix, Color.rgb(0, 217, 181), "v0.1.1-login-declutter", "JellyMix.apk"),
