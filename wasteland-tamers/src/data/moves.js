...
export function movesForCreature(creature) {
  ...
  return [
    { id: `${creature.familyId}-basic`, name: names[0], kind: 'STRIKE', power: 1.0, accuracy: 1, cooldown: 0, unlockLevel: 1 },
    { id: `${creature.familyId}-tech`, name: names[1], kind: 'TECH', power: 1.35, accuracy: 0.92, cooldown: 1, unlockLevel: 4 },
    { id: `${creature.familyId}-control`, name: names[2], kind: 'CONTROL', power: 0.75, accuracy: 0.88, cooldown: 2, unlockLevel: 8, status: effect ?? 'confuse' },
    { id: `${creature.familyId}-capstone`, name: names[3], kind: 'CAPSTONE', power: 2.0, accuracy: 0.78, cooldown: 3, unlockLevel: 14 },
  ];
}
