...
| --- | --- | --- | --- |
| Smithware Studios / DevHub | `BadBagger/softsmith-devhub` | `com.softsmith.devhub` | `v2.1.5-order-radar-draft-edit` |
...
| Order Radar | `BadBagger/order-radar` | `com.smithware.orderradar` | `v0.4.1-order-draft-edit` |
